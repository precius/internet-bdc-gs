...
const serviceHall = {
  ...
  //拍摄功能
  getWxMonitor(params){
    return fetch("uploadfileConfigController/getWxMonitor", "get", params);
  },
  //保存不动产信息
  ...
  //获取附件信息
  getUploadFilesBySubcfgCode(params){
  ...
  //获取上传图片----材料示例中会用到
  viewUploadFile(params){
     return fetch("fileUploadController/viewUploadFile", "get", params);
  },
  //上传图片-----FMS服务器
  // uploadfile(params) {
  // 	return fetch("file/uploadFileByBase64", "post", params);
  // },
  //保存图片
  ...
  updateFileInfo(params) {
    return fetch("fileUploadController/updateFileInfo", "post", params);
  },
  //根据文件id删除文件信息
  deleteUploadFile(params) {
    return fetch("fileUploadController/deleteUploadFile", "post", params);
  },
  //根据文件fileid获取文件（图片）--------FMS
  // getfileList (params) {
  //   return fetch("file/findFileById", "get", params);
  // },
  //根据文件fileid删除文件（图片） --------FMS
  // delFileById (params) {
  //   return fetch("file/delFileById", "get", params);
  // },
  //验证信息的判断
  //判断是否有数字
  ...
  idcard: function(value) {
    ...
    switch (idcard.length) {
      case 15:
        if ((parseInt(idcard.substr(6, 2)) + 1900) % 4 === 0 || ((parseInt(idcard.substr(6, 2)) + 1900) % 100 ===
            0 && (parseInt(idcard.substr(6, 2)) + 1900) % 4 === 0)) {
          ereg =
      ...
      case 18:
        ...
        if (parseInt(idcard.substr(6, 4)) % 4 === 0 || (parseInt(idcard.substr(6, 4)) % 100 === 0 && parseInt(
            idcard.substr(6, 4)) % 4 === 0)) {
          ereg =
            /^[1-9][0-9]{7}[0-9]{2}((01|03|05|07|08|10|12)(0[1-9]|[1-2][0-9]|3[0-1])|(04|06|09|11)(0[1-9]|[1-2][0-9]|30)|02(0[1-9]|[1-2][0-9]))[0-9]{3}[0-9Xx]$/; //闰年出生日期的合法性正则表达式
        } else {
          ereg =
            /^[1-9][0-9]{7}[0-9]{2}((01|03|05|07|08|10|12)(0[1-9]|[1-2][0-9]|3[0-1])|(04|06|09|11)(0[1-9]|[1-2][0-9]|30)|02(0[1-9]|1[0-9]|2[0-8]))[0-9]{3}[0-9Xx]$/; //平年出生日期的合法性正则表达式
        }
